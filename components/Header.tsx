    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" role="navigation" aria-label="Main navigation">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center" aria-label="Urban Timber Tree Service - Home">
            <div className="w-8 h-8 bg-green-700 rounded-full mr-3" aria-hidden="true"></div>
            <span className="text-xl font-bold text-green-700">Urban Timber Tree Service</span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <a 
              ...
              title="Email Urban Timber Tree Service"
              aria-label="Email Urban Timber Tree Service"
            >
            ...
            <a 
              ...
              aria-label="Call Urban Timber Tree Service at 503-449-4066"
            >
