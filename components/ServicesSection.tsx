      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We offer comprehensive tree care services to keep your property safe and beautiful. 
            All work is performed by certified arborists with attention to safety and quality.
          </p>
        </div>
